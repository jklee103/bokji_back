import sqlite3
# uid, 비번, 이름, 나이, 성별,지역, -불린 임신,출산,아동청소년, 청년, 중장년, 노년, 장애인, 한부모, 다문화, 저소득층, 보훈여부
...
def makedb():
    ...
    cs.execute(query)
    query = "CREATE TABLE user (uid VARCHAR(40) primary key, pwd VARCHAR(40), name VARCHAR(20), age integer, " \
